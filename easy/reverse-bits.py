...
class Solution:
    def reverseBits(self, n: int) -> int:
        ...
        # it will be a 31 bit integer
        for i in range(32):
            # we need to get the ith bit of n
            # we will take n and shift all the way to the right then in n we will
            # have the target bit we were looking for
            bit = (n >> i) & 1
            res = res | (bit << (31 - i))
        return res
...
s = Solution()
print(s.reverseBits(n=0o000010100101000001111010011100))
